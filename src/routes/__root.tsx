...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Amulya Rayabhagi — Portfolio" },
      {
        name: "description",
        content:
          "M.S. Computer Science (Data Science) @ UT Dallas — builder of intelligent systems, multi-agent AI, and scalable web platforms.",
      },
      { name: "author", content: "Amulya Rayabhagi" },
    ],
    links: [
